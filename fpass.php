      ...
      <form class="form-signin" method="post">
        <h2 class="form-signin-heading">Mot de passe oublié</h2><hr />
			...
			else
			{
				...
				S'il vous plaît entrez votre adresse email. Vous recevrez un lien pour créer un nouveau mot de passe par email.
				</div>  
                <?php
			}
			?>
        ...
        <input type="email" class="input-block-level" placeholder="Adresse email" name="txtemail" required />
     	<hr />
        <button class="btn btn-danger btn-primary" type="submit" name="btn-submit">Generer un nouveau Mot de passe</button>
      </form>
